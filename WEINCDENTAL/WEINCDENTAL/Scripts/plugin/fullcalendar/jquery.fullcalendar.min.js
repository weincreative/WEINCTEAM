/*! WEINCREATIVE - v1.0 - 2019-01-01 */ ! function (a) {
    ...
    function h(c, d) {
        ...
        var fb, gb, hb, ib, jb, kb, lb, mb, nb, ob = ab.isFetchNeeded,
            pb = ab.fetchEvents,
            qb = c[0],
            rb = 0,
            sb = 0,
        ...
        function f(d) {
            ...
            return f && a.each(f.split(" "), function (d) {
                ...
                a.each(this.split(","), function (d, g) {
                    if ("title" == g) e.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), f && f.addClass(m + "-corner-right"), f = null;
                    else {
                        var h;
                        if (b[g] ? h = b[g] : Fb[g] && (h = function () {
                            o.removeClass(m + "-state-hover"), b.changeView(g)
                        }), h) {
                            var i, j = D(c.themeButtonIcons, g),
                                k = D(c.buttonIcons, g),
    ...
    function j(b) {
        ...
        function e(b, c) {
            f(b, function (d) {
                ...
                if (c == G) {
                    if (d)
                        for (e = 0; e < d.length; e++) f = d[e], g || (f = u(f, b)), f && L.push(f);
                    H-- , H || C(L)
                }
            })
        }
        ...
        function h(b) {
            ...
            if (a.isFunction(b) || a.isArray(b) ? c = {
                ...
                "url": b
            } : "object" == typeof b && (c = a.extend({}, b), "string" == typeof c.className && (c.className = c.className.split(/\s+/))), c) {
        ...
        function o(a) {
            ...
            for (b = 0; b < L.length; b++)
                if (c = L[b], c._id == a._id && c !== a)
                    for (d = 0; d < M.length; d++) e = M[d], void 0 !== a[e] && (c[e] = a[e])
        }
    ...
    function I(a, b) {
        var c = a.source || {},
            ...
            e = c.color,
            f = b("eventColor"),
            g = a.backgroundColor || d || c.backgroundColor || e || b("eventBackgroundColor") || f,
            h = a.borderColor || d || c.borderColor || e || b("eventBorderColor") || f,
    ...
    function $(b, c, d) {
        ...
        var J, K, L, M, N, O, P, Q, R, S, T, U, V, W, X, Y, Z, $, ab, bb, cb, db, eb, fb, gb = I.opt,
            hb = I.trigger,
            ib = I.renderOverlay,
            jb = I.clearOverlays,
            kb = I.daySelectionMousedown,
            lb = I.cellToDate,
            mb = I.dateToCell,
            nb = I.rangeToSegments,
            ob = c.formatDate,
            pb = c.calculateWeekNumber;
    ...
    function eb(c, d, e) {
        ...
        function h() {
            var d, e, f, g, h = Hb + "-widget-header",
                j = Hb + "-widget-content",
                k = rb.asMinutes() % 15 === 0;
        ...
        function l() {
            var a, b, c, e, f, g = Hb + "-widget-header",
                h = Hb + "-widget-content",
        ...
        function m(a) {
            ...
            var b = X.position().top,
                c = gb.position().top,
                d = Math.min(a - b, jb.height() + c + 1);
            ab.height(d - w(_)), bb.css("top", b), gb.height(d - c - 1);
            var e = jb.find("tr:first").height() + 1,
                f = jb.find("tr:eq(1)").height();
        ...
        function u(a) {
            if (!Nb("selectable")) {
                var b = Math.min(Bb - 1, Math.floor((a.pageX - U.offset().left - nb) / ob)),
                    c = Vb(0, b),
        ...
        var U, V, W, X, Y, Z, $, _, ab, bb, cb, db, eb, gb, hb, ib, jb, kb, lb, mb, nb, ob, pb, rb, sb, tb, ub, zb, Bb, Cb, Db, Eb, Fb, Gb, Hb, Jb, Kb, Lb, Mb, Nb = T.opt,
            Ob = T.trigger,
            Pb = T.renderOverlay,
            Qb = T.clearOverlays,
            Rb = T.reportSelection,
            Sb = T.unselect,
            Tb = T.daySelectionMousedown,
            Ub = T.slotSegHtml,
            Vb = T.cellToDate,
            Wb = T.dateToCell,
            Xb = T.rangeToSegments,
            Yb = d.formatDate,
            Zb = d.calculateWeekNumber,
            $b = {};
    ...
    function fb() {
        ...
        function e(a) {
            var b, c, d, e, g, h = G(),
                ...
                k = [];
            for (c = 0; h > c; c++)
                for (b = F(0, c), g = f(a, b.clone().time(i), b.clone().time(j)), g = gb(g), d = 0; d < g.length; d++) e = g[d], e.col = c, k.push(e);
            return k
        }
        ...
        function g(b, c) {
            var d, e, f, g, j, k, l, m, q, r, t, u, v, x, z, B, E = b.length,
                F = "",
                G = y(),
                H = n("isRTL");
        ...
        function j(a, c, d) {
            ...
            c.draggable({
                ...
                "stop": function (d, f) {
                    if (k.stop(), U(), o("eventDragStop", c[0], a, d, f), g) e(), c.css("filter", ""), P(a, c);
                    else {
        ...
        function k(a, b, c) {
            ...
            var f, g, h, i, j, k, l, p, q, r, s, t, u, v = m.getCoordinateGrid(),
                w = G(),
                x = H(),
                y = J(),
                z = K();
    ...
    function ib(a) {
        ...
        for (b = 0; b < a.length; b++)
            for (c = a[b], d = 0; d < c.length; d++)
                for (e = c[d], e.forwardSegs = [], f = b + 1; f < a.length; f++) mb(e, a[f], e.forwardSegs)
    }
    ...
    function kb(a, b, c) {
        ...
        if (void 0 === a.forwardCoord)
            for (e.length ? (e.sort(ob), kb(e[0], b + 1, c), a.forwardCoord = e[0].backwardCoord) : a.forwardCoord = 1, a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / (b + 1), d = 0; d < e.length; d++) kb(e[d], 0, a.forwardCoord)
    }
    ...
    function rb() {
        ...
        function k(a, b) {
            var c, d = l(a),
                ...
                f = [];
            if (b)
                for (c = 0; c < e.length; c++) e[c].height(d[c]);
    ...
    var Gb = {
        ...
        Hb = 1;
    Eb.applyAll = J;
    var Ib = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        Jb = /^\s*\d{4}-\d\d$/,
        Kb = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/;
    Eb.moment = function () {
        return L(arguments)
    ...
    var Mb = {
        ...
        Nb = {};
    Fb.month = X, Fb.basicWeek = Y, Fb.basicDay = Z, e({
        "weekMode": "fixed"
    }), Fb.agendaWeek = ab, Fb.agendaDay = bb, e({
        "allDaySlot": !0,
        "allDayText": "tum-gun",
        "scrollTime": "06:00:00",
